...
def run_metrics(budget_units: int, max_requests: int, timeout: int) -> int:
    ...
    os.environ["YOUTUBE_API_RUN_BUDGET_UNITS"] = str(max(0, int(budget_units)))
    os.environ["YOUTUBE_API_UNITS_USED_SESSION"] = "0"
    ...
    metrics = {
        ...
        "quota_units_used_session_env": int(os.getenv("YOUTUBE_API_UNITS_USED_SESSION", "0") or 0),
